...
- dividing by 0 and 0.0 already discussed in 4.8
...
Note: Alternatively, one or both of the second and third operands is allowed to be a throw expression. We cover `throw` in lesson [27.2 -- Basic exception handling](https://www.learncpp.com/cpp-tutorial/basic-exception-handling/).(didnt understand)
...
- C++ doesn’t provide an explicit _logical XOR_ operator
