...
Before C++20, if you wanted to tell a background thread to stop running, you had to manually create an `std::atomic<bool> keep_running (`[[7. Lock-Free Programming]] ) variable, pass it to the thread, and check it in a loop. 
