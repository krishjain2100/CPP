...
How to determine if a constexpr function call is evaluating at compile-time or runtime
...
1. As [the paper that proposed this feature](https://www.open-std.org/jtc1/sc22/wg21/docs/papers/2018/p0595r2.html) indicates, the standard doesn’t actually make a distinction between “compile time” and “runtime”. Defining behaviour involving that distinction would have been a larger change.
