...
You can use a forward declaration to access a function or variable in another file. The scope of the declared variable or **function**(emphasis on function) is as per usual (global scope for globals, block scope for locals).
...
| thread_local | thread storage duration(did not understand, part of concurrency)           |                     |
