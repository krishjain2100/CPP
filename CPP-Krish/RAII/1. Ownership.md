...
If some object “owns” a resource, it is responsible for freeing it when appropriate (e.g., calling delete, or letting a smart pointer’s destructor free it).
...
### Example 1: **Reference does NOT manage lifetime**
...
---
### Example 2: **Pointer does NOT manage lifetime either**
...
---
### Example 3: **Object owns its own lifetime
