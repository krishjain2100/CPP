...
**Daemon**-A **daemon** 👻 (pronounced "demon") is a specific type of background process in an operating system that runs continuously and handles system requests without any direct user interaction.
### 2. The Docker Engine
