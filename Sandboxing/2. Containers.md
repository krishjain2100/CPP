...
- **PID Namespace (Process ID):** In Linux, the very first thing that boots is PID 1, and every other program branches off it. If you look at the host, your containerised app might be process ID `4598`. But inside the container's PID namespace, the app looks at itself and sees PID `1`. It thinks it is the absolute root of the computer.
